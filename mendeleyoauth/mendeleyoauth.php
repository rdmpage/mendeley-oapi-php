...
class MendeleyOAuth {
  ...
  public $host = "http://api.mendeley.com/oapi/";
  /* Set timeout default. */
  public $timeout = 30;
  /* Set connect timeout. */
  ...
  public $http_info;
  /* Set the useragnet. */
  public $useragent = 'MendeleyOAuth';
   ...
   * Set API URLS
   */
  function accessTokenURL()  { return 'http://www.mendeley.com/oauth/access_token/'; }
  function authenticateURL() { return ''; }
  function authorizeURL()    { return 'http://www.mendeley.com/oauth/authorize/'; }
  function requestTokenURL() { return 'http://www.mendeley.com/oauth/request_token/'; }
  ...
  /**
   * construct MendeleyOAuth object
   */
  ...
  /**
   * Get a request_token from Mendeley
   *
